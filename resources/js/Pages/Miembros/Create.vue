                ...
                <div class="mb-4 border border-gray-200 rounded-lg">
                  <button type="button" class="w-full p-4 text-left bg-white border-b border-blue-500 focus:outline-none" @click="toggleAccordion('section1')">
                    ...
                    <div id="section1" class="hidden p-4">
                        ...
                        <input type="number" v-model="form.telefono" id="telefono" class="mt-1 block w-full p-2 border border-gray-300 rounded-md"
                ...
                <div class="mb-4 border border-gray-200 rounded-lg">
                    ...
                    <div id="section2" class="hidden p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="telefonoContacto" v-model="form.telefonoContacto" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <span v-if="form.errors.telefonoContacto" class="text-red-500 text-sm">{{ form.errors.telefonoContacto }}</span>
