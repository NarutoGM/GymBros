  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
        ...
        <div class="min-w-0 px-4  ">
            <form class="mt-6 space-y-3 max-w-full">
                <div class="grid gap-6  mb-8 md:grid-cols-1 lg:grid-cols-2 p-4">
                    <!-- Columna 1: Selección de Productos e Información del Cliente -->
                    <div class="space-y-4 border rounded-lg shadow-xs p-5" >
    ...
    <input readonly :value="currentDate" type="text" id="fecha" name="fecha" class="mt-1 block w-full border-gray-300 rounded-md shadow-md bg-gray-200 text-gray-800 sm:text-sm p-2" />
                        ...
                        <div>
                            ...
                            <select id="producto" name="producto" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                ...
                                <option value="">Seleccionar...</option>
                                <!-- Reemplaza con opciones dinámicas si es necesario -->
                                <option value="1">SUPLEMENTO1</option>
                                <option value="2">SUPLEMENTO2</option>
                            </select>
                        </div>
                        <div class="flex justify-end mt-4">
                    <SecondaryButton type="submit">Añadir producto</SecondaryButton>
                </div>
                        ...
                        <div class=" border shadow-xs rounded-t-lg p-4 ">
                            ...
                            <table class="min-w-full divide-y divide-gray-200   mt-4">
                                <thead class="bg-blue-700  ">
                                    <tr >
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-100  uppercase tracking-wider">Producto</th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-100  uppercase tracking-wider">Cantidad</th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-100  uppercase tracking-wider">Precio</th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-100  uppercase tracking-wider">Subtotal</th>
                                    </tr>
                                </thead>
